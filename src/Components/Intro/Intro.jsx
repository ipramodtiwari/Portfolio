    ...
    <div className='intro'>
        <div className='i-left'>
          ...
          <div className='i-icons'>
            <a href='https://github.com/ipramodtiwari'>  
              <img src={Github} alt=''/>
            </a>
            <a href='https://www.linkedin.com/in/ipramodtiwari/'>
              <img src={LinkedIn} alt=''/>
            </a>
            <a href='https://www.instagram.com/ipramodtiwari/'>
